...
I want to first think how I comment on resumes.
I am not getting paid to do make comments.
For people I am not acquainted with, I usually point out one or two areas where improvements can be made.
I also want to try making comments that I do not usually write to test its reception.
Public forums is also a good way to validate my comments.


I want my advice to be implemented, but I want to be polite.
It is also possible that my recommendations is disagreed by many.


These are some ways that I preface my comments, in varying degress of forcefulness
- Consider <verb> / <noun> ...
...
I can also add a context to the comment
...
I strongly recommend resumes to take up exactly one full page.
...
Job titles used should be conventional, even if it may differ from your actual title in the contract or in the company.
In the big tech companies, "senior", "staff", "principal", "manager" and "lead" means something.
...
Some resumes use terminologies that requires Googling, or not even Google-able.
...
> You mentioned that you "created a new web application with React". What is the web application?
...
> For projects you worked with in a team, mention the specific parts you built.
...
> You mentioned that "Improved model training time by 10%". What was done? What is the benefit?
...
Some bullet points clearly have a measurable impact.
...
Metrics described should be specific as well.

> You mentioned that your work increased the number of users by 10%.
> Could you specify how the metric is measured? (Daily active users? Number of unique browser visits? A/B tested?)
...
It suspect that it is common to see recruiters scanning the skills section to determine a skill fit.
...
While soft skills are important at work, it is not something you want to claim to have in your resume.
...
> I think you are placing too much empahsis on the lines of codes written which is not a good measure of proficiency.
