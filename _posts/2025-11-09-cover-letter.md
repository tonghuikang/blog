...
I design, implement and test changes for Quora feed and digest recommendations.
I know the system end-to-end enough that I can investigate any issue with the recommendation system.
I run the ML systems design interview for recommendation systems and AI engineering.

I am the main maintainer for [CLAUDE.md](https://blog.huikang.dev/2025/05/31/writing-claude-md.html) and [hooks](https://github.com/tonghuikang/claude-code-template/) for the company monorepo.
I developed the internal agentic query over the data lake to answer any data questions.
I invented some coding interview problems that are AI-resistant for now.
I still do LeetCode for [fun](https://leetcode.cn/u/tonghuikang/).

I built the process to generate questions on [recent events](https://www.quora.com/topic/Recent-Events).
I wrote prompts to label topics on content, and created the pipeline to backfill new [topics](https://www.quora.com/topic/DeepSeek-V3-AI-model).
...
I have also experimented with automated [prompting](https://autoprompt.huikang.dev/html_output/prompt-history-classification.html), [animating](https://tonghuikang.github.io/flash-attention-animation/) [flash](https://www.quora.com/How-does-flash-attention-work/answer/Tong-Hui-Kang-1) [attention](https://github.com/tonghuikang/llm_architecture), and [AI](https://www.facebook.com/codingcompetitions/hacker-cup/2024/final-round/scoreboard?track=AI_CLOSED_TRACK) [competitive](https://github.com/tonghuikang/meta-ai-hackercup-2024) [programming](https://github.com/tonghuikang/meta-ai-hackercup-2025).
